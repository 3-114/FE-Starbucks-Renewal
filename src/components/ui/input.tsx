  ...
  "text-base outline-none transition-[color,box-shadow] disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        login:
          "w-full border-0 border-b border-gray-300 bg-transparent px-0 shadow-none font-black text-[14px] rounded-none placeholder:text-black placeholder:tracking-tighter placeholder:pb-[1px]",
      },
    },
    defaultVariants: {
      variant: "default",
